...
conn.execute('CREATE TABLE Users(Username TEXT, FirstName TEXT, LastName TEXT, DOB DATE, Pass TEXT)') #  we should probably store passwords differently, how to store Date?
